  ...
  const rules = [
    {
      ...
      title: "The Basics",
      description:
        "Play in a giant 3x3 grid where each cell contains its own small Tic-tac-toe board.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Your move position in a small board determines which board your opponent must play in next.",
    },
    {
      icon: <ArrowRight className="size-5 text-green-500" />,
      title: "Free Move",
      description:
        "If sent to a completed board, you can choose any available board to play in.",
    },
    {
      icon: <XCircle className="size-5 text-muted-foreground" />,
      title: "Board Completion",
      description:
        "A small board is won by getting three in a row, or declared a draw if no more moves are possible.",
    },
  ];
      ...
      <DialogContent className="flex max-h-[85vh] max-w-2xl flex-col gap-6 overflow-y-auto">
        ...
        <div className="space-y-6 text-muted-foreground">
          <p className="leading-relaxed">
            Super Tic-tac-toe adds an exciting strategic layer to the classic
          ...
          <div className="space-y-2 rounded-lg bg-muted p-4 text-sm">
            ...
            <ul className="list-disc space-y-1 pl-4">
              <li>
                Think two moves ahead - where will your move send your opponent?
              </li>
              <li>
                Sometimes forcing a draw in a small board is better than losing
                it
              </li>
